...
export default function EscribirNoticia() {
  ...
  const imageHandler = () => {
    ...
    input.onchange = async function () {
      ...
      const id = await uploadPostImg(file);
      const link = `http://localhost:4001/uploads/${id}`;

      // Acceder al editor de Quill utilizando la referencia
      console.log(link);
      ...
      setImageFiles((prev) => [...prev, { path: link, id }]);
    };
  };
